...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        String header = Utils.color(String.format("&8&m-&d&m-&8&m--|&r &5Locked&dDimension&8 &5&lV&d%s\n&8&m--|&r &dCommands:\n&8&m----|\n", lockedDimension.getDescription().getVersion()));
        sender.sendMessage(header);
        commands.forEach(commandHandler -> sender.sendMessage(Utils.color("&8&m-|&r &8/&5lockeddimension &d" + commandHandler.getName() + " &8- &d" + commandHandler.getDescription())));
